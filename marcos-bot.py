...
class Marcos(telepot.helper.ChatHandler):
   ...
   def do_alert(self):
      ...
      self._slogan_editor.editMessageText(alarm_text)
   ...
   def send_start_slogan(self):
      ...
      if self._slogan_editor != None:
         self._slogan_editor.editMessageText(slogan_text)
      else:
         sent = self.sender.sendMessage(slogan_text)
         self._slogan_editor = telepot.helper.Editor(self.bot, sent)
   ...
   def on_callback_query(self, msg):
      ...
      if data == 'stop_cry_detector':
         self.stop_cry_detector()
         self._slogan_editor.editMessageText("Bye!")
         self._commands_editor.editMessageText("Bye!")
